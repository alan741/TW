      ...
      <div class="row d-flex justify-content-center">
          <div class="col-md-6">
            ...
            <div class="row">
                <div class="col-md-12">
                    <br>
                <button type="button" style="margin: 10px" onclick="ConfirmarCompra()" class="btn btn-outline-success" data-toggle="modal" data-target="#ventana1" >Confirmar compra</button>
